...
|---|---|---|
| **S1** | Repaso REST · diseño de recursos, jerarquías y versionado | [1. Diseño de APIs REST](01-diseno-rest/) §1–4 |
| **S2** | `ResponseEntity` y control fino de la respuesta | [2. Respuestas y errores](02-respuestas-y-errores/) §1–2 |
| **S3** | Cabeceras, `Location` y negociación de contenido | [2. Respuestas y errores](02-respuestas-y-errores/) §3 |
| **S4** | Errores con **Problem Details** (RFC 7807) | [2. Respuestas y errores](02-respuestas-y-errores/) §4–5 |
| **S5** | Paginación con `Pageable` y ordenación | [3. Paginación y búsqueda](03-paginacion-y-busqueda/) §1–3 |
| **S6** | Filtrado y búsqueda por criterios combinables | [3. Paginación y búsqueda](03-paginacion-y-busqueda/) §4–5 |
| **S7** | OpenAPI: documentar la API · Swagger UI y anotaciones | [4. Documentar con OpenAPI](04-documentacion-openapi/) |
| **S8** | Lo que REST no resuelve: *over-* y *under-fetching* | [5. GraphQL](05-graphql/) §1–2 |
| **S9** | Esquema, `@QueryMapping` y el *playground* | [5. GraphQL](05-graphql/) §3–4 |
| **S10** | Mutaciones y `@BatchMapping`: el N+1 otra vez · cuándo REST y cuándo GraphQL | [5. GraphQL](05-graphql/) §5–6 |
| **S11** | Tiempo real: *polling*, SSE y WebSockets | [6. WebSockets](06-websockets/) §1–2 |
| **S12** | STOMP: canales, suscripciones y difusión | [6. WebSockets](06-websockets/) §3–4 |
| **S13** | Un chat y un panel de stock en vivo | [6. WebSockets](06-websockets/) §5 |
| **S14** | Tests de API con `MockMvc` y de integración | [7. Testing de APIs](07-testing-apis/) |
| **S15** | Consumir otras APIs con `RestClient` | [8. Consumir APIs](08-consumir-apis/) |
| **S16** | Laboratorio: la API de la biblioteca, paginada y filtrable | [Batería de ejercicios](ejercicios/) |
| **S17** | Repaso integrador, documentación y dudas | [Preparar el examen](examen/) |
| **S18** | :material-laptop: **Examen práctico de RA7 (100 %)** | [Preparar el examen](examen/) |

## Cómo se evalúa

**Examen práctico (100 %)**: ampliar una API existente con paginación, filtrado, documentación, una consulta GraphQL y tests. Rúbrica de seis criterios, publicada en la [página de preparación](examen/).

## Material

- [Reto con tests](practicas/)
